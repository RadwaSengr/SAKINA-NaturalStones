...
export default function App() { return <ErrorBoundary><ThemeProvider defaultTheme="light"><TooltipProvider><LanguageProvider><CartProvider><WouterRouter base={basePath}><StorefrontChrome /><Routes /><Toaster /></WouterRouter></CartProvider></LanguageProvider></TooltipProvider></ThemeProvider></ErrorBoundary>; }
